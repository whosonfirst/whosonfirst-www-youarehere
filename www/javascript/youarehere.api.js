function youarehere_api_call(method, data, on_success, on_error){

    var endpoint = youarehere_api_endpoint();
	...
	if (! data.access_token){
	    data.append('access_token', youarehere_api_site_token());
	}
	...
	if (! data['access_token']){
	    data['access_token'] = youarehere_api_site_token();
	}
    }
...
function youarehere_api_endpoint(){
	return document.body.getAttribute("data-api-endpoint");
}

function youarehere_api_site_token(){
